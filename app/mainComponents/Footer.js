...
const Footer = ({ color }) => {
  ...
  return (
    <footer
      className={`source-sans-3 py-2 w-full text-center ${color} text-[#231F20]`}
    >
      Designed and coded by Zhoe Aeris
      <br />
      <ul className="flex justify-center py-1">
        <li className="text-gray-600 px-1">
          <a href="https://www.linkedin.com/in/zhoeaeris/" target="_blank">
            {linkedIn}
          </a>
        </li>
        <li className="text-gray-600 px-1">
          <a href="mailto:zhoe.aeris@gmail.com" target="_blank">
            {email}
          </a>
        </li>
        <li className="text-gray-600 px-1">
          <a href="https://www.github.com/zhoexaeris/" target="_blank">
            {github}
          </a>
        </li>
      </ul>
