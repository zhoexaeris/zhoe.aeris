...
const Header = () => {
  ...
  return (
    <div className="max-w-4xl">
      <h1 className="text-xl sm:text-4xl  font-extrabold text-[#231F20] leading-tight tracking-tight mb-6">
        Zhoe is a{" "}
        <span className="bg-gradient-to-r from-pink-500 to-orange-400 bg-clip-text text-transparent">
          Frontend Developer
        </span>
        , who bridges design and code to{" "}
        <span className="transition-all duration-300 inline-block min-w-[2ch] bg-[#F84B82] text-white px-2 py-1 rounded-md text-center ">
          {words[currentWordIndex]}
        </span>{" "}
        digital experiences.
      </h1>
      <p className="text-base sm:text-lg text-[#231F20] mb-8 max-w-3xl">
